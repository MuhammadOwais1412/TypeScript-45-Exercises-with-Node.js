...
while (guestlist.length > 2) {
    ...
    console.log("Sorry, ".concat(Removeguests, " I can't invite you to dinner"));
}
// Sending a invitation Message to last two remaining guests
console.log("Invitation to the last two guests");
guestlist.forEach(function (invitedguests) { return console.log("hello ".concat(invitedguests, " you are still invited to dinner")); });
